...
class BottomBarPenerima extends StatefulWidget {
  static const String routeName = '/home';
  const BottomBarPenerima({super.key});

  @override
  State<BottomBarPenerima> createState() => _BottomBarState();
}

class _BottomBarState extends State<BottomBarPenerima> {
  int _page = 0;
